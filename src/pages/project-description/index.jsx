    ...
    <div id='projectDescriptionContainer'>
      <div id='projectDescriptionHeader'>
        <div id='projectDescriptionHeaderText'>
          <h1 id='projectDescriptionHeaderTextTitle' className='projectDescriptionTitle'>{project.title}</h1>
          <p className='projectDescriptionTextDescription'>{project.description}</p>
        </div>
